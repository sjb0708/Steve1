  ...
  async function loadNotifications() {
    try {
      ...
      if (res.ok) {
        ...
        // Opening the inbox counts as seeing everything: clear unread on the
        // server (the sidebar badge goes away) but keep the local flags so
        // the "new" highlights stay visible for this visit.
